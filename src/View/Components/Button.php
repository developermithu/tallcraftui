...
class Button extends Component
{
    ...
    public function colorClasses(): string
    {
        ...
        return match (true) {
            $this->isPrimaryWithoutOthers() && $notOtherStyle => 'bg-violet-600 text-white hover:bg-violet-700 focus:bg-violet-700 focus:ring-violet-500 active:bg-violet-800',
            $this->secondary && $notOtherStyle => 'bg-gray-200 hover:bg-gray-300 focus:ring-gray-500',
            $this->warning && $notOtherStyle => 'bg-yellow-600 text-white hover:bg-yellow-700 focus:bg-yellow-700 focus:ring-yellow-500 active:bg-yellow-800',
            $this->danger && $notOtherStyle => 'bg-red-600 text-white hover:bg-red-700 focus:bg-red-700 focus:ring-red-500 active:bg-red-800',
            $this->success && $notOtherStyle => 'bg-green-600 text-white hover:bg-green-700 focus:bg-green-700 focus:ring-green-500 active:bg-green-800',
            $this->info && $notOtherStyle => 'bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-700 focus:ring-blue-500 active:bg-blue-800',
            default  => '',
        };
    }
    ...
    {
        return match (true) {
            $this->outline && $this->isPrimaryWithoutOthers() => '!bg-transparent !border-violet-300 text-violet-600 hover:bg-violet-100 focus:bg-violet-100 active:bg-violet-100 focus:ring-violet-500',
            $this->outline && $this->secondary => '!bg-transparent !border-gray-300 text-gray-600 hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100 focus:ring-gray-500',
            $this->outline && $this->warning => '!bg-transparent !border-yellow-300 text-yellow-600 hover:bg-yellow-100 focus:bg-yellow-100 active:bg-yellow-100 focus:ring-yellow-500',
            $this->outline && $this->success => '!bg-transparent !border-green-300 text-green-600 hover:bg-green-100 focus:bg-green-100 active:bg-green-100 focus:ring-green-500',
            $this->outline && $this->danger => '!bg-transparent !border-red-300 text-red-600 hover:bg-red-100 focus:bg-red-100 active:bg-red-100 focus:ring-red-500',
            $this->outline && $this->info => '!bg-transparent !border-blue-300 text-blue-600 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-100 focus:ring-blue-500',
            default => "",
        };
    }
    ...
    {
        return match (true) {
            $this->flat && $this->isPrimaryWithoutOthers() => '!bg-transparent text-violet-600 hover:bg-violet-100 focus:bg-violet-100 active:bg-violet-100 focus:ring-violet-500',
            $this->flat && $this->secondary => '!bg-transparent text-gray-600 hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100 focus:ring-gray-500',
            $this->flat && $this->warning => '!bg-transparent text-yellow-600 hover:bg-yellow-100 focus:bg-yellow-100 active:bg-yellow-100 focus:ring-yellow-500',
            $this->flat && $this->success => '!bg-transparent text-green-600 hover:bg-green-100 focus:bg-green-100 active:bg-green-100 focus:ring-green-500',
            $this->flat && $this->danger => '!bg-transparent text-red-600 hover:bg-red-100 focus:bg-red-100 active:bg-red-100 focus:ring-red-500',
            $this->flat && $this->info => '!bg-transparent text-blue-600 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-100 focus:ring-blue-500',
            default => "",
        };
    }
